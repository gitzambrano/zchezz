...
engine/c/zchezz_v325/    default supported engine; NNU3
...
Operational entry points must work with no required CLI arguments and default safely to v325 unless the file is explicitly family-specific. Cross-family orchestration selects a profile and uses UCI process boundaries.
