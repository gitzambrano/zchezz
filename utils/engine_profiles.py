...
PROFILES = {
    "v325": EngineProfile("v325","NNU3",ROOT/"engine/c/zchezz_v325",ROOT/"checkpoints/v325",ROOT/"train/train_nnu3.py",ROOT/"train/export_nnu3.py",ROOT/"train/import_nnu3.py"),
    "v500": EngineProfile("v500","NNU4",ROOT/"engine/c/zchezz_v500",ROOT/"checkpoints/v500",ROOT/"train/train_nnue.py",ROOT/"train/export_nnu4.py",ROOT/"train/import_nnu4.py"),
}
