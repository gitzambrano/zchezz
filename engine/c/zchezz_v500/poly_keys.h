/* poly_keys.h - Standard Polyglot Zobrist keys (781 values)
 * Auto-generated from python-chess polyglot module.
 * These are the universal constants used by ALL Polyglot-compatible tools.
 */
#pragma once
#include <stdint.h>
