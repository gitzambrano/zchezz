...
def _steps(profile:str): return MODULE.profiles("v506","v327")[profile]
...
def test_regression_uses_selected_candidate_and_baseline():
    c=_step("regression","quick H2H").command; text=" ".join(c); assert "zchezz_v506" in text and "zchezz_v327" in text; assert "--engine-a" in c and "--engine-b" in c and "--threads" in c
